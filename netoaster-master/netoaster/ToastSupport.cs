...
namespace netoaster
{
    ...
    class ToastSupport
    {
        public static StoryBoard GetAnimation(ToasterAnimation animation, ref Grid toaster, int timeActive)
        {
            ...
            SplineDoubleKeyFrame frame = new SplineDoubleKeyFrame();
                    ...
                    if (timeActive > 0)
                        fadeout.BeginTime = TimeSpan.FromSeconds(timeActive);
                    else
                        fadeout.BeginTime = TimeSpan.FromSeconds(100000);
